  ...
  <?php else: ?>
    <table class="admin-table">
      <thead>
        <tr>
          <th>Date</th>
          <?php foreach (array_slice($inputFields, 0, 6) as $field): ?>
            <th><?= e($field['label']) ?></th>
          <?php endforeach; ?>
          <th></th>
        </tr>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            ?>
              <td><?= e(mb_strimwidth((string) $val, 0, 80, '…')) ?></td>
            <?php endforeach; ?>
            <td>
              <details>
                ...
                <dl style="font-size:0.85rem;margin:0.5rem 0;">
                  ...
                  <?php foreach ($files as $file): ?>
                    <dt><strong>File (<?= e($file['field_id']) ?>)</strong></dt>
                    <dd><?= e($file['original_name']) ?> (<?= (int) $file['size'] ?> bytes)</dd>
                  <?php endforeach; ?>
                </dl>
              </details>
            </td>
