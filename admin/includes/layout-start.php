...
<head>
  ...
  <link rel="stylesheet" href="/admin/css/admin.css?v=49">
...
<body class="admin-body">
  ...
  <aside class="admin-sidebar" id="admin-sidebar" aria-label="Admin navigation">
    ...
    <div class="admin-sidebar-foot">
      ...
      ?>
      <div class="admin-sidebar-user-card<?= $activeNav === 'profile' ? ' is-active' : '' ?>">
        <a href="/admin/profile" class="admin-sidebar-user-main" title="Edit profile">
          <?php if ($__avatarUrl): ?>
            <img src="<?= e($__avatarUrl) ?>" alt="" class="admin-sidebar-avatar admin-sidebar-avatar--image">
          <?php else: ?>
        ...
        <div class="admin-sidebar-user-tools">
          <a href="/" target="_blank" rel="noopener" class="admin-sidebar-tool-btn" title="View website" aria-label="View website">
          ...
          <a href="/admin/logout" class="admin-sidebar-tool-btn admin-sidebar-tool-btn--logout" title="Log out" aria-label="Log out">
